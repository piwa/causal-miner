...
@Data
@RelationshipEntity(type = "INSTANCE_FOLLOW_UP")
public class InstanceRelationship implements IHomogeneousRelationship<InstanceActivity> {
    ...
    public InstanceRelationship(InstanceActivity startEvent, InstanceActivity endEvent) {
